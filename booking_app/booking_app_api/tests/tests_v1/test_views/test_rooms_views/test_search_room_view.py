...
from booking_app_admin.models import Room, Booking
...
@pytest.fixture
def test_rooms(db):
    room1 = Room.objects.create(name="Для двоих", price_per_day=Decimal("100.00"), capacity=2)
    room2 = Room.objects.create(name="Для одного", price_per_day=Decimal("50.00"), capacity=1)
    return room1, room2
